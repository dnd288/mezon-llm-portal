...
|---|---|---|
| **A screen that has stopped being one component** | 24 props / 6 stateful hooks / 800 code lines / complexity 45 | `composite-complexity` · your project architectural decisions · `mlp-ui-development` §9 |
