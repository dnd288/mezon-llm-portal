...
- **OQ1**: *Adopted test stack*. Setup Vitest (unit/lib tests) and Playwright (Chromium E2E browser tests with mock session fixture). Tested with `bun run test`, `bun run test:e2e`, and `bun run test:all`.
